...
void Action_setBindings(Htop_Action* keys) {
   ...
   keys['1'] = actionHelp;
   keys['2'] = actionSetup;
   keys['3'] = actionIncSearch;
   keys['4'] = actionIncFilter;
   keys['5'] = actionToggleTreeView;
   keys['6'] = actionSetSortColumn;
   keys['7'] = actionHigherPriority;
   keys['8'] = actionLowerPriority;
   keys['9'] = actionKill;
   keys['0'] = actionQuit;
